  ...
  return (
    <div className="bg-white min-h-screen pb-20 lg:pb-8">
      ...
      <div className="px-5 pt-6 pb-4 flex items-center lg:px-8 lg:pt-8 lg:pb-6 lg:border-b lg:border-gray-200">
        <button
          onClick={() => navigate(-1)}
          className="w-10 h-10 rounded-full flex items-center justify-center mr-3 hover:bg-gray-100 transition-colors lg:hover:bg-gray-50 active:scale-90 transition-all"
        >
        ...
        <div>
          ...
          <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mt-1 hidden lg:block">Управление вашим садом</p>
        </div>
      </div>
      ...
      <div className="px-5 lg:px-8 lg:py-6">
        <div className="space-y-1">
            <button 
                ...
                className="w-full flex items-center justify-between py-5 border-b border-gray-50 hover:bg-gray-50 transition-all group"
            >
            ...
            <div className="w-full flex items-center justify-between py-5 border-b border-gray-50">
                <div className="flex items-center gap-4">
            ...
            <button className="w-full flex items-center justify-between py-5 border-b border-gray-50 hover:bg-gray-50 transition-all group">
                <div className="flex items-center gap-4">
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-5 animate-in fade-in duration-300">
          <div className="bg-white rounded-[2.5rem] p-8 max-w-sm w-full shadow-2xl scale-in-center border border-gray-100">
            ...
            <p className="text-sm font-medium text-gray-500 text-center mb-8 leading-relaxed">
              Вы уверены, что хотите деактивировать свой профиль? Все ваши вакансии будут удалены.
            </p>
